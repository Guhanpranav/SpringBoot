...
public class TransactionController {
    ...
    @Transactional
    public ResponseEntity<String> makeTransaction(@ModelAttribute Transaction t, HttpSession ss){
        ...
        Optional<User> receiver = userRepo.findByAccNo(t.getReceiverAccNumber());

        long senderBalance = sender.get().getBalance();
        long receiverBalance = receiver.get().getBalance();

        long transferAmount = t.getAmount();
        ...
        Sendertrans.setReceiverAccNumber(t.getReceiverAccNumber());
